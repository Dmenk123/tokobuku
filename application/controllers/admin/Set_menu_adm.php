...
class Set_menu_adm extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('adm_model/mod_set_menu_adm','m_menu');
	}
	...
	public function index()
	{
		...
		$content = [
			'css'	=> 'adm_view/css/css_set_menu_adm',
			'modal' => 'adm_view/modal/modalSetMenuAdm',
			'js'	=> 'adm_view/js/js_set_menu_adm',
			'view'	=> 'adm_view/v_set_menu'
		];
	...
	public function list_menu()
	{
		...
		foreach ($list as $listMenu) {
			...
			if ($listMenu->aktif_menu == 1) {
				$row[] =
				'<a class="btn btn-sm btn-primary" title="Edit" href="'.base_url('admin/set_menu_adm/edit_menu/'.$listMenu->id_menu).'"><i class="glyphicon glyphicon-pencil"></i></a>
