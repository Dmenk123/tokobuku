				...
				<div class="box" id="checkout_detail">
					<div class="box-body">
						<div class="table-responsive">
							...
							<div class="col-xs-4">
								<h5 style="text-align: left;">Nama User : <?php $nm = explode(',', $data_komisi[0]->nama_lengkap_user);
																			echo $nm[0] . ' ' . $nm[1]; ?></h5>
								<h5 style="text-align: left;">Kode Ref : <?php echo $data_komisi[0]->kode_ref; ?></h5>
							</div>
							<div class="col-xs-4">
								<h4 style="text-align: center;">Tanggal Transaksi: <?php echo date("d-m-Y", strtotime($data_komisi[0]->created_at)); ?></h4>
							</div>
								...
								<table id="tabelCheckoutDetail" class="table table-bordered table-hover" border="1" cellspacing="0" width="100%">
									<thead>
										<tr>
											...
											<th style="width: 50px; text-align: center;">Komisi Agen</th>
										</tr>
									</thead>
									<tbody>
										<?php $no = 1; ?>
										<?php foreach ($data_komisi as $val) : ?>
											<tr>
												<td><?php echo $no++; ?></td>
												...
												<td><?php echo "Rp. " . number_format($val->laba_agen, 0, ",", "."); ?></td>>
											</tr>
										<?php endforeach ?>
									</tbody>
								</table>
