    ...
    <section class="content-header">
    	...
    	<ol class="breadcrumb">
    		...
    		<li class="active">Verifikasi Klaim Agen</li>
    	</ol>
    </section>
    						...
    						<div class="tab-content">
    							<div class="tab-pane active" id="tab_progress">
    								...
    								<div class="box-body">
    									...
    									<div class="table-responsive">
    										<table id="tabelKlaim" class="table table-bordered" cellspacing="0" width="100%">
    											<thead>
    												<tr>
    													<th>Tanggal</th>
    													<th>Nama Agen</th>
    							...
    							<div class="tab-pane" id="tab_finish">
    								...
    								<div class="box-body">
    									...
    									<!-- end flashdata -->
    									<div class="table-responsive">
    										<table id="tabelKlaimFinish" class="table table-bordered" cellspacing="0" width="100%">
    											<thead>
    												<tr>
    													<th>Tanggal</th>
                                                        <th>Nama Agen</th>
