            ...
            <div class="box-body">
              <form id="form_input">
               ...
               <div class="form-group col-md-12">
                  ...
                  <textarea class="form-control" rows="3" placeholder="Keterangan ..." id="keterangan" name="keterangan" ><?php if(isset($hasil_data)){echo $hasil_data->keterangan;}?></textarea>
                  <span class="help-block"></span>
                </div>

                <div class="form-group col-md-4">
                  <label>Dimensi Panjang : </label>
                  <input type="text" class="form-control numberinput" id="panjang" name="panjang" value="<?php if(isset($hasil_data)){echo $hasil_data->panjang;}?>">
                  <span class="help-block"></span>
                </div>
                ...
                <div class="form-group col-md-8">
                  ...
                  <input type="text" class="form-control" id="penerbit" name="penerbit" value="<?php if(isset($hasil_data)){echo $hasil_data->penerbit;}?>">
                  <span class="help-block"></span>
                </div>
                ...
                <?php for ($i=0; $i <= 2; $i++) { ?>
                  <div class="form-group col-md-9">
                    ...
                    <input type="file" id="gambar<?=$i;?>" class="gambar" name="gambar[]";/>
                  </div>

                  <div class="form-group col-md-3">
                    <?php if(isset($hasil_data)){ ?>
                      <img id="gambar<?=$i;?>-img" src="<?= base_url().'/assets/img/foto_guru/'.$hasil_data->foto; ?>" alt="Preview Gambar" height="75" width="75" class="pull-right"/>
                    <?php } else { ?>
