 				...
 				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
 					<aside class="ps-widget--footer ps-widget--info">
 						<header><a class="ps-logo" href="index.html"><img src="images/logo-white.png" alt=""></a>
 							<h3 class="ps-widget__title" style="color: black;">Address Office 1</h3>
 						</header>
 						<footer>
 		...
 		<div class="ps-container">
 			<div class="row">
 				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
 					<p>&copy; <a href="#">CV. NURCAHYONO</a>, Inc. All rights Resevered. Design by <a href="#"> Mas Nur Cahyono</a></p>
 				</div>
 				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
 					<ul class="ps-social">
