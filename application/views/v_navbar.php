...
<html lang="en">
  ...
  <head>
    ...
    <meta name="keywords" content="Ayo Nyetrum ke Bp. Cipto Junaedy. Agar Cepat Ketularan jadi Teladan Hidup Besar.">
    <meta name="description" content="Ayo Nyetrum ke Bp. Cipto Junaedy. Agar Cepat Ketularan jadi Teladan Hidup Besar.">
    <meta property="og:site_name" content="Majang Dapat Uang Cipto Junaedy">
    <meta property="og:title" content="Cipto Junaedi" />
    <meta property="og:description" content="Ayo Nyetrum ke Bp. Cipto Junaedy. Agar Cepat Ketularan jadi Teladan Hidup Besar." />
    <meta property="og:image" itemprop="image" content="<?php echo base_url();?>assets/img/thumb-meta/majangdapatuang.PNG"/> 
    <meta property="og:type" content="website" />
    <title>Dalam 30 hari Jago Cash Banyak</title>
    <!-- Fonts-->
    <link href="https://fonts.googleapis.com/css?family=Archivo+Narrow:300,400,700%7CMontserrat:300,400,500,600,700,800,900" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo base_url();?>assets/plugins/font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?php echo base_url();?>assets/plugins/ps-icon/style.css">
    <!-- CSS Library-->
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/'); ?>vendor/css/video.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/'); ?>resources/sass/modules/_header.scss">
    <!-- Custom-->
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAx39JFH5nhxze1ZydH-Kl8xXM3OK4fvcg&amp;region=GB"></script><script type="text/javascript" src="<?php echo base_url();?>assets/plugins/revolution/js/jquery.themepunch.tools.min.js"></script>
